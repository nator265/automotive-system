...
const ShowroomPage = () => {
  ...
  return (
    <>
      ...
      <div className="pt-5 bg-linear-to-br from-slate-50 via-slate-100 to-slate-50 min-h-screen">
        {/* Back Button */}
        <Link href={"/client-dashboard/browse-fleet"}>
          <div className="mb-5 flex align-center gap-5">
            <ArrowBackIcon /> Back to Browse Fleet
          </div>
        </Link>
        {/* Main Content */}
        <div className="px-4">
