  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-gray-100 to-white">
      <div className="absolute top-8 left-8 flex gap-5">
        <ArrowBackIcon className="text-gray-700 hover:text-gray-900 transition-colors duration-300" />
        <div className="text-gray-700 font-semibold">Automotive</div>
      </div>

      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-lg p-8 animate-fade-in">
          <h3 className="text-2xl font-bold mb-6">Welcome!</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="flex flex-col space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="border border-gray-300 p-2 pl-10 rounded-md w-80 focus:ring-2 focus:ring-blue-500"
                  required
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="bg-blue-500 text-white p-2 rounded-md w-80 hover:bg-blue-600 transition-all duration-300"
            >
